export const planResult = async (calMin, calMax,calMinBreakfast,calMaxBreakfast,calMinLunch,calMaxLunch,calMinDinner,calMaxDinner,dietH,allergyC) => {
    try {
  ...
  export const mealsData = async (id) => {
    try {
